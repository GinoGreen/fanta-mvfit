...
export const SquadColumn = ({ className, squad }: SquadColumnProps) => {
	return (
		<div className={cn("h-full w-full", className)}>
			<div className='rounded-t-lg bg-popover transition-all hover:bg-[#2CA6A4]/70 h-14 border-b-4 border-secondary flex flex-col items-center justify-center cursor-pointer'>
				<p className='text-center text-sm font-bold'>{squad.name}</p>
				<p className='text-center text-primary/60 text-xs font-bold'>500</p>
			</div>
